...
class TestBinary(unittest.TestCase):
    def test01_add(self):
        ...
        self.assertEqual(bn.add("00100011", "00000110"), "00101001", msg)
    ...
    def test04_binary_to_decimal(self):
        ...
        self.assertEqual(bn.binary_to_decimal("11111111"), 255, msg)
        self.assertEqual(bn.binary_to_decimal("11010100"), 212, msg)
